...
contract Power {
    ...
    constructor() {
        ...
        maxExpArray[96] = 0x01e46a502d95f2e68df975caeffffffff;
        maxExpArray[97] = 0x01cd902fd1ad073fe301f1d56bffffffff;
        maxExpArray[98] = 0x01b558b5b4c3f8b542ae6d04c5ffffffff;
        maxExpArray[99] = 0x01a4a1497cc5ff1d86db69a05effffffff;
        maxExpArray[100] = 0x0193e3ec434079582c9a8c4f0cffffffff;
    ...
    /**
     * Calculate the power of a base number with fractional exponents
     * @param _baseN Numerator of the base
     * @param _baseD Denominator of the base
     * @param _expN Numerator of the exponent
     ...
     * @param _numerator Input numerator
    ...
    function ln(uint256 _numerator, uint256 _denominator) internal pure returns (uint256) {
        ...
        // If x >= 2, compute integer part of log2(x)
        if (x >= FIXED_2) {
        ...
        // Compute fraction part of log2(x)
        if (x > FIXED_1) {
    ...
    /**
     * Calculate floor of binary logarithm
     * @param _n Input number
     * @return Floor of binary logarithm
     */
    ...
    /**
     * Find position in maxExpArray
     * @param _x Input value
     * @return Position in maxExpArray
     */
    ...
    function fixedExp(uint256 _x, uint8 _precision) internal pure returns (uint256) {
        ...
        // The calculation remains identical to the original implementation
        // (Full series expansion coefficients are preserved)
        xi = (xi * _x) >> _precision;
